...
<div class="content">
	<h1>CSS 5 Examples link</h1>

	<h3>CSS Syntax</h3>
	<div class="jigs-bar-block">
		<a sveltekit:prefetch class="jigs-button jigs-bar-item jigs-grey" 
			target="_blank"
			href="/trycss_syntax1"
		>
			CSS syntax
	...
	<h3>CSS Selectors</h3>
	<div class="jigs-bar-block">
		<a class="jigs-button jigs-bar-item ws-grey" 
			sveltekit:prefetch 
			target="_blank" 
			href="/trycss_syntax_element">
			The element selector
		</a>
		<!-- <a class="jigs-button jigs-bar-item ws-grey jigs-border-top" target="_blank" href="tryit.asp?filename=trycss_syntax_id">The id selector</a>
